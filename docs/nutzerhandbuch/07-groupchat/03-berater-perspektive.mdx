...
## Video-Gruppenchat erstellen und starten

Beraterinnen und Berater, die von den Administratoren die entsprechenden Rechte erhalten haben, finden den Gruppenchat-Button unter Meine Beratungen. Wenn Berater nicht über diese Rechte verfügen, können sie keine Gruppenchats erstellen. Sie können jedoch an bestehenden Gruppenchats teilnehmen. Sie können diese Chats jedoch nicht starten. Durch Anklicken des Icon-Buttons mit dem Chat-Bubble kann man einen neuen Video-Gruppenchat erstellen. Um die Gruppenchats von den 1:1 Beratungen zu unterscheiden, befindet sich links oben auf der Chat-Kachel das gleiche Icon wie auf dem Erstellungs-Button.

![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/01_Screenshot.png)
...
![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/02_Screenshot.png)

Sie erhalten eine Systemmeldung, dass der Video-Gruppenchat erfolgreich erstellt wurde. Sie sehen nun den neuen Gruppenchat mit den angehängten "Spielregeln" des Chats. Um die allgemeinen Texte der Chatregeln anzupassen, kontaktieren Sie uns bitte. Derzeit können wir keine spezifischen Texte für die verschiedenen Gruppenchats anbieten.

Unter <UIElement>Chat-info</UIElement> können Sie bereits den Einladungslink kopieren und die Teilnehmer_innen einladen. Unter <UIElement>Chat-info</UIElement> finden Sie alle Einstellungen zum Video-Gruppenchat, wie z.B. Dauer und Datum des Chats, die Sie jederzeit ändern können.
...
![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/03_Screenshot.png)

Wenn Sie auf Chat Start klicken, wird der Chat als aktiv angezeigt.

![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/04_Screenshot.png)
...
![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/06_Screenshot.png)

## Videokonferenz starten und beitreten

Eine Videokonferenz kann von allen Beratern gestartet werden, die am Video-Gruppenchat teilnehmen. Um die Videokonferenz zu starten, klicken Sie auf das <UIElement>Kamera-Symbol</UIElement> in der oberen Leiste des Video-Gruppenchats.

![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/07_Screenshot.png)

Der Ablauf der Videokonferenz ist ähnlich wie bei der Videoberatung aufgebaut. Bei den anderen Teilnehmern wird der Anruf mittels Overlay und dem bekannten Klingelton empfangen. Dem Benutzer stehen die gleichen Funktionen zur Verfügung. Mehr zu den Möglichkeiten der Videoberatung finden Sie in Kapitel Video-Beratung.
...
![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/08_Screenshot.png)

## Video-Gruppenchat beenden oder verlassen
...
![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/09_Screenshot.png)

Wenn Sie nicht mehr am Video-Gruppenchat teilnehmen möchten, klicken Sie auf <UIElement>Chat verlassen</UIElement>. Die Einladung zum Gruppenchat bleibt jedoch in Ihrer Chat-Übersicht auf der linken Seite verfügbar. Sie können zu einem späteren Zeitpunkt wieder daran teilnehmen. Bitte beachten Sie, dass wenn alle Moderatoren den Chat verlassen haben, die Ratsuchenden nicht mehr am Chat teilnehmen können. Ein vollständiges Löschen der Einladung und des Video-Gruppenchats ist derzeit nicht möglich.

![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/10_Screenshot.png)

## Ratsuchenden aus dem Video-Gruppenchat verbannen
...
![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/11_Screenshot.png)
...
![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/12_Screenshot.png)

Ratsuchende, die verbannt von einem wurden, erhalten folgende Nachricht:

![Video-Gruppenchat](../../../static/img/images-onlineberatung/07_VideoGruppenChat/13_Screenshot.png)
