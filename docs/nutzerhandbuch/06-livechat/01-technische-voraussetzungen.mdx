...
<PrimaryNote>
  Bei der Funktion "1:1Chat" handelt es sich um eine optionale Zusatzfunktion.
  Um Zugriff auf diese Funktion zu haben, muss also Ihre
  Online-Beratungsplattform diese Zusatzfunktion gebucht haben.
</PrimaryNote>

Um den 1:1 Chat bestmöglich verwenden zu können, benötigen Sie einen der folgenden Browser:
