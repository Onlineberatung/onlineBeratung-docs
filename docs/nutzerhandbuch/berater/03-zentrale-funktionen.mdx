...
<p><img src={useBaseUrl('/img/images-onlineberatung/mobile/01_Berater_ZentraleFunktionen.png')} style={{ height: '400px' }}/></p>

<span>Am linken Bildschirmrand befindet sich die Navigationsleiste, mit verschiedenen Reitern, je nach Konfiguration sind nicht alle davon Verfügbar <strong>(1)</strong>:</span>
...
<span><strong>(6)</strong> Hier gibt es mehrere Optionen:</span>
...
<p><img src={useBaseUrl('/img/images-onlineberatung/mobile/01_Berater_ArchivierenUndLöschen.png')} style={{ height: '400px' }}/></p>