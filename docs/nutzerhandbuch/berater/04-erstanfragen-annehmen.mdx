...
<p><img src={useBaseUrl('/img/images-onlineberatung/mobile/01_Berater_Erstanfragen.png')} style={{ height: '400px' }}/></p>
...
### Ersttermine
Wenn Sie die Terminfunktionalität nutzen, dann können Ratsuchenden mit ihrer Beratungsstelle Erstberatungstermine vereinbaren. Sobald ein Ersttermin mit einem der Berater*innen gebucht wurde, sind die Ratsuchenden zugewiesen und nicht mehr in der Liste der Erstanfragen. 