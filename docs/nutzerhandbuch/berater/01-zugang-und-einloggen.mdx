...
<PrimaryNote>
  Die Beratungsplattform funktioniert auch auf Smartphones und Tabletts. Im
  Folgenden sehen sie auch immer die entsprechenden Ansichten in der
  Mobilversion. Die Bedienung erfolgt analog zur Desktopversion und enthält
...
<p>
  <img
    src={useBaseUrl("/img/images-onlineberatung/mobile/01_Berater_Login.png")}
    style={{ height: "400px" }}
  />
</p>
